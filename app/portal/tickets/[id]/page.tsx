...
import { ArrowLeft, Paperclip, User2, Clock, CheckCircle2, Info } from "lucide-react";
          ...
          <CardContent className="p-4">
            ...
            <div className="mt-1 font-medium">
              {ticket.time_estimate_minutes != null
                ? `${ticket.time_estimate_minutes} min`
                : "—"}
            </div>
          </CardContent>
        </Card>
        <Card className="border-slate-200">
          <CardContent className="p-4">
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <div className="font-medium">{ticket.staff?.name ?? "Unassigned"}</div>
